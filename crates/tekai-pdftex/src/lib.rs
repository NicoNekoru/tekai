//! Experimental pdfTeX rewrite track for `tekai`.
//!
...
//! `pdflatex` in the hot path without shrinking `tekai`'s final-build
//! objective.
...
pub use contract::{
    ...
    PdfTexResponsibility, PerformanceStrategy, RewritePlan, TekaiResponsibility,
};
pub use engine::{
