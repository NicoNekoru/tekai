/// Responsibilities that stay in the current `tekai` orchestrator.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum TekaiResponsibility {
    SourceDiscovery,
    BuildStateCache,
    HotPathScheduling,
...
pub struct EngineBoundary {
    pub tekai_owned: &'static [TekaiResponsibility],
    pub pdftex_owned: &'static [PdfTexResponsibility],
}

pub const CURRENT_ENGINE_BOUNDARY: EngineBoundary = EngineBoundary {
    tekai_owned: &[
        TekaiResponsibility::SourceDiscovery,
        TekaiResponsibility::BuildStateCache,
        TekaiResponsibility::HotPathScheduling,
        TekaiResponsibility::OptionalInteropToolScheduling,
        TekaiResponsibility::ExternalAssetPreparation,
        TekaiResponsibility::FastPreviewPatching,
        TekaiResponsibility::WatchInvalidation,
        TekaiResponsibility::CliAndJsonReporting,
    ],
    pdftex_owned: &[
