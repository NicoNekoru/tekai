//! Self-contained exact typesetting engine for Tekai.
//!
...
//! while its runtime boundaries are implemented directly in this crate.
...
#[cfg(all(
    not(test),
    feature = "c-entrypoint",
    not(feature = "standalone-binary")
))]
#[no_mangle]
